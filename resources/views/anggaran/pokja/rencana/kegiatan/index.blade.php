      ...
      <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header bg-white">
                <h5 class="card-title text-black">A. Biaya Konsumsi Rapat Pimpinan / POKJA </h5>
            </div>
            <div class="pl-4">
                <a class="btn btn-secondary" href="{{ route('kegiatan.create') }}">
                    + Tambah Kegiatan
                </a>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row xp-button ml-1">
                                    ...
                                    <a href="{{ route('kegiatan.create') }}" class="btn btn-round btn-info"> <i class="mdi mdi-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
                        <tr>
