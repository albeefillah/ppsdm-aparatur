...
<div class="xp-contentbar">
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        ...
        <div class="card m-b-30">
            <div class="card-body">
                <iframe title="Visual Analytics Perjadin 2024" height="550px" width="100%" src="https://app.powerbi.com/view?r=eyJrIjoiMjExM2EyNWMtNWYxMC00NzVlLWI0YTctYjMwMjQ0Y2RhYmI5IiwidCI6ImY4YjA2MGZmLWNhMDYtNDBmOS05YTE2LTRmZjcwYzgwZTZhZCIsImMiOjEwfQ%3D%3D&embedImagePlaceholder=true" frameborder="0" allowFullScreen="true"></iframe>
            </div>
