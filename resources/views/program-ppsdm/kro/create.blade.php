        ...
        <div class="col-md-6 col-lg-6">
            <div class="xp-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah KRO</li>
                </ol>
            </div>
        </div>
    </div>          
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header bg-white">
                <h5 class="card-title text-black">Tambah KRO</h5>
                <h6 class="card-subtitle">Isi form dibawah ini.</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('kro.store') }}" onsubmit="return Validation()" enctype="multipart/form-data">
                    @csrf
