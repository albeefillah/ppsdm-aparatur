@section('title') 
PPSDM Aparatur - Tambah Detail Komponen
@endsection 
        ...
        <div class="col-md-6 col-lg-6">
            <div class="xp-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Detail Komponen</li>
                </ol>
            </div>
        </div>
    </div>          
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header bg-white">
                <h5 class="card-title text-black">Tambah Detail Komponen</h5>
                <h6 class="card-subtitle">Isi form dibawah ini.</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('detail-komponen.store') }}" onsubmit="return Validation()" enctype="multipart/form-data">
                    @csrf
