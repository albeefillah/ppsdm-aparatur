@section('title') 
PPSDM Aparatur - Realisai Anggaran
@endsection 
...
<div class="xp-breadcrumbbar">
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <h4 class="xp-page-title">Realisasi Anggaran</h4>
        </div>
        <div class="col-md-6 col-lg-6">
      ...
      <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header bg-white">
                <h5 class="card-title text-black">Data Realisasi Anggaran</h5>
            </div>
            {{-- <div class="pl-4">
                <a href="{{ route('mata_anggaran.create') }}" class="btn btn-secondary">+ Tambah Realisasi Anggaran</a>
            </div> --}}
            <div class="card-body">
                        ...
                        @endforeach --}}
                            ...
                            <tr>
                                ...
                                <td>Kode	Deskripsi	Pagu	Aksi
                                    ...
                                    602	Melaksanakan Penyusunan Karya Ilmiah PPSDM Aparatur	127.960.000	
                                    A	Karya Tulis Ilmiah PPSDM Aparatur	462.853.000</td>
                                <td><span class="badge badge-warning">Pengawasan</span></td>
                                <td>
                                    <a href="{{ route('realisasi.create') }}" class="btn btn-info mb-1"> <i class="mdi mdi-pencil"></i> Isi Realisasi</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
